...
const HomePage = () => {
  ...
  const mapOptions = [
    ...
    const customSuggestions =[
          {name: "Yasumoto International Academic Park", location: {	lat: 114.210932, lng: 22.4162632}}
        ];
      const displayCustomSuggestions = (userInput) => {
          return customSuggestions.filter(suggestion => 
